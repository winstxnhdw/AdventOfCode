...
fn check_if_assignments_overlap(pair_assignment: &Vec<Vec<i32>>) -> bool {
    ...
    !(assignment_one_sortable[1] < assignment_two_sortable[0]
        || assignment_two_sortable[1] < assignment_one_sortable[0])
}
